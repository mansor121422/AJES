...
<body>
    ...
    <div class="card">
        ...
        <p style="margin-bottom: 16px; color: #558b2f;">All users will be notified when you publish.</p>
        <form action="<?= base_url('announcements/store') ?>" method="post">
            ...
            <button type="submit" class="login-button" style="display: inline-flex; width: auto; padding: 10px 24px;">Publish (notify all users)</button>
