    ...
    <div class="card">
        ...
        <form action="<?= base_url('records/update/' . $record['id']) ?>" method="post">
            ...
            <div class="form-group">
                ...
                <small style="color: #666;">For immediate Guidance + parent call, set type to <strong>Misbehavior</strong> and include <strong>fighting</strong> or <strong>bullying</strong> in details.</small>
            </div>
